 ...
 *
 * Создайте 3 класс геометрические фигуры: Круг (англ. Circle), Прямоугольник (англ. Rectangle) и Треугольник (англ. Triangle).
 ...
 * Реализация этих методов будет разной для каждой из геометрических фигур. Формулы для вычисления площади и периметра легко находятся в интернете.
 * После того, как геометрические фигуры будут полностью реализованы, вам необходимо будет реализовать еще один класс - TestFigures.
...
public class TestFigures {
    ...
    //В этом классе реализуйте два метода: public static double calculateRedPerimeter(Figure[] figures), public static double calculateRedArea(Figure[] figures)
    public static double calculateRedPerimeter(Figure[] figures) {
        ...
        //Вызовите эти методы на массиве figures и выведите результат в консоль.
        return sum;
    }

    //метод public static double calculateRedArea(Figure[] figures)
    public static double calculateRedArea(Figure[] figures) {
